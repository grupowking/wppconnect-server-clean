// VERSÃO FINAL E CORRIGIDA - src/routes/index.ts
...
// Group... (todas as outras rotas continuam aqui, sem alteração)
// ... (cole o resto do arquivo original a partir daqui ou deixe como está se a lógica de grupo não for necessária)
